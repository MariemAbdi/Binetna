...
class ApprovedCertifs extends StatefulWidget {
  const ApprovedCertifs({Key? key}) : super(key: key);

  @override
  State<ApprovedCertifs> createState() => _ApprovedCertifsState();
}

class _ApprovedCertifsState extends State<ApprovedCertifs> {
  ...
  Future<String?> openDialog()=>showDialog<String>(context: context, builder: (context)=> AlertDialog(
    ...
    actions: [
      ...
      }, child: Text(LocaleKeys.DONE.tr(), style: TextStyle(color: MyThemes.darkgreen),))
    ],
  ));
}
